...
## Acceptance criteria
- [x] No page introduces horizontal scrolling on a 360px-wide viewport.
- [x] All primary actions remain reachable on mobile: login/register, request/reset password, create task, open/close modal, update plan, logout.
- [x] Task modal content is usable on mobile (no clipped bottom actions; content scrolls when needed).
- [x] Error pages show both action buttons without overlap or truncation.
- [x] Desktop layout remains intact (no obviously broken spacing).
