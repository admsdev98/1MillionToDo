...
## Acceptance criteria
- [x] On mobile widths, dashboard and settings show a hamburger button and do not show the full inline nav.
- [x] Tapping the hamburger toggles the menu open/closed.
- [x] Navigation items inside the menu work (Dashboard, Settings) and Logout still logs out.
- [x] Language toggle remains reachable on mobile.
- [x] No horizontal scrolling is introduced by the header on mobile.
